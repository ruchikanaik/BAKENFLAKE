...
<body>
      ...
      <div class="collapse navbar-collapse " id="myNavbar">
        ...
        ?>
          <ul class="nav navbar-nav navbar-right">
            ...
            <li><a href="foodlist.php"><span class="glyphicon glyphicon-cutlery"></span> Menu Zone </a></li>
  ...
  ?>
    <div class="container">
      <div class="jumbotron">
        <h1>Your Shopping Cart</h1>
        <p>Oops! We can't smell any product here. Your cart is empty. Go back and <a href="foodlist.php">order now.</a></p>
