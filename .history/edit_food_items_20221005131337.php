  ...
  <div class="container">
    ...
    <div class="col-xs-3" style="text-align: center;">
      ...
      <div class="list-group">
        ...
        <a href="edit_food_items.php" class="list-group-item active">Edit Product Items</a>
        <a href="delete_food_items.php" class="list-group-item ">Delete Products Items</a>
