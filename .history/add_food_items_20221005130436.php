  ...
  <div class="container">
    ...
    <div class="col-xs-3" style="text-align: center;">
      ...
      <div class="list-group">
        ...
        <a href="add_food_items.php" class="list-group-item active">Add PRODUCT Items</a>
    ...
    <div class="col-xs-9">
      <div class="form-area" style="padding: 0px 100px 100px 100px;">
        <form action="add_food_items1.php" method="POST">
          <br style="clear: both">
          <h3 style="margin-bottom: 25px; text-align: center; font-size: 30px;"> ADD NEW PRODUCT ITEM HERE </h3>
